      ...
      <v-card-text>
        ...
        >
          <BaseButton
            ...
            secondary
            target="_blank"
            href="https://github.com/abdo14m1/mealie/issues/new/choose"
          >
            <template #icon>
            ...
            >
              ...
              <template v-else-if="property.slot === 'build'">
                <v-list-item-subtitle>
                  <a
                    target="_blank"
                    :href="`https://github.com/abdo14m1/mealie/commit/${property.value}`"
                  >
                    {{ property.value }}
                  </a>
                </v-list-item-subtitle>
              ...
              <template v-else-if="property.slot === 'version' && property.value !== 'develop' && property.value !== 'nightly'">
                <v-list-item-subtitle>
                  <a
                    target="_blank"
                    :href="`https://github.com/abdo14m1/mealie/releases/tag/${property.value}`"
                  >
                    {{ property.value }}
                  </a>
                </v-list-item-subtitle>
